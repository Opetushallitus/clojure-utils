...
(ns oph.postgresql-util
  "Useille sovelluksille yhteisiä tietokantatarkistuksia"
  (:require [korma.core :as sql]))

(defn tarkista-triggerit
 "Tarkistaa että tietokannassa on kaikilla tauluilla, paitsi Flywayn kirjanpitotaululla, triggereitä. Ts. ainakaan ne eivät ole kokonaan unohtuneet vahingossa."
 []
