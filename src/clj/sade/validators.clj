; Otettu Lupapiste-projektilta: https://raw.githubusercontent.com/lupapiste/lupapiste/develop/src/sade/validators.clj
; (Lupapisteen lähdekoodi on EUPL-lisenssoitu, joten sitä voidaan käyttää myös OPH:n EUPL-lisenssoiduissa projekteissa.)

; In english:
; Taken from Lupapiste project: https://raw.githubusercontent.com/lupapiste/lupapiste/develop/src/sade/validators.clj
; The source code for Lupapiste is under EUPL-license, which means it can be used for EUPL-licensed projects in National Board of Education
